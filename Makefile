...
switch = -O2
objects = OptQC_Bridge.o OptQC_Common.o OptQC_Common_Module.o OptQC_CSD.o OptQC_Main.o OptQC_Perm.o OptQC_WKVar.o OptQC_CPLX_Main.o OptQC_RNG.o OptQC_MRGRNK.o OptQC_MPI.o
...
OptQC_Main.o: common_module.mod csd_tools.mod csd_perm.mod rng.mod m_mrgrnk.mod csd_mpi.mod
...
OptQC_CPLX_Main.o: common_module.mod csd_tools.mod csd_perm.mod rng.mod m_mrgrnk.mod csd_mpi.mod
